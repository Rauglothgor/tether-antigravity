# ADR: TETHER 2.0 Enterprise Agentic OS Upgrade

## [2026-01-13] - Transition to TETHER 2.0 (Enterprise)

### Context
Standard TETHER (v1.0) was effective for small projects but lacked robust knowledge management, specialist role tracking, and automated auditing for long-running autonomous tasks (like /godmode). Context decay and lack of a structured knowledge hierarchy were emerging blockers.

### Decision
Upgrade the system to "TETHER 2.0" (Enterprise Agentic OS). This includes:
1. Persistent knowledge base (`.tether/knowledge/`).
...
### Consequences
- Root folder stays clean of TETHER's own meta-history.
